window.addEventListener('DOMContentLoaded', function () {
	...
	let deadline = '2022-12-29';											//Время остановки таймера
	...
	persons.addEventListener('change', function () {								//При заполнении инпута формы persons
		...
		total = (daysSum + personsSum) * 4000;										//Алгоритм расчета(передается заказчиком)
	...
	let formBase = document.querySelector('.form-contact'),
